...
> * **The Methodology:** Using a localized 'palay' price of the Philippines from 2016-2025, we prove that "Queen-logic" fails to accurately capture maritime spillovers, resulting in statistically significant error bias ($p < 0.05$).
